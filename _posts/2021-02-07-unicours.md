...
Result: Outcome: A single page web app with a fluid (non-fragmented interaction) that is also adaptive. It includes all the features previously available in the original version.

</div>

<h3 class= "stage-title">Discovery and Concept Development</h3>
...
<h3 class= "stage-title">Design and Prototyping</h3>
